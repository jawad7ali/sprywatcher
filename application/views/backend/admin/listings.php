        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-account-circle title_icon"></i> <?php echo get_phrase('listings'); ?>
                    <a target="_blank" href="<?php echo site_url('user/listing_add'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_new_listing'); ?></a>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
                            ...
                            <td class="text-center">
                                ...
                                <div class="dropright dropright">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <?php if ($listing['status'] == 'pending'): ?>
                                            <li><a class="dropdown-item" href="<?php echo site_url('admin/listings/make_active/'.$listing['id']); ?>" ><?php echo get_phrase('mark_as_active'); ?></a></li>
                                        <?php else: ?>
                                            <li><a class="dropdown-item" href="<?php echo site_url('admin/listings/make_pending/'.$listing['id']); ?>" ><?php echo get_phrase('mark_as_pending'); ?></a></li>
                                        <?php endif; ?>
