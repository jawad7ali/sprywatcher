	(function(A) {
	var input_loc = document.getElementById('search_bar');
    ...
    google.maps.event.addListener(loc, 'place_changed', function(){
       ...
       if(place.formatted_address){
    	...
    	let lat = place.geometry.viewport.ka.g;
    	let long = place.geometry.viewport.pa.g;
      	 
        document.getElementById('categorySideMap').innerHTML = "<div id='map' style='width: 100%; height: 100%;'></div>";
		createListingsMap2({
			mapId: 'map',
			long: long,
			lat: lat,
