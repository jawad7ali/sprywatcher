...
function createListingsMap2(options) {
    ...
    */
    ...
    $.getJSON(settings.jsonFile).done(function (json) {
            ...
            map.panTo(new L.LatLng(settings.long,settings.lat,4), { animation: true });
    ...
    */
    ...
    function getPopupContent(properties) {
        ...
        if (properties.image) {
            ...
            var image1 = '<img width="280" src="'  +  settings.imgBasePath +  properties.image + '"> ';
        ...
        if (settings.mapPopupType == 'venue') {
            ...
            '<div class="popup-venue card" style="height:400px;">' +
            ...
            //     '<div style = "overflow: hidden;">' +'<img src="'  + properties.image + '" class="card-img-top">'+ '</div>'+
            //     '<div class="card-body">'+
            //         '<div class="">' +title +' </div>' +
            //         '<div>'+ address +'</div>'+
            //         '<div>'+ phone +'</div>'+
