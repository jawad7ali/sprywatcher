...
class User extends CI_Controller {
	...
	public function listings_submit()
	{	
		

		$in_id =$this->crud_model->add_listing();
        $this->frontend_model->post_review_post($in_id);
		redirect(site_url('user/listing_add'));
	}
	...
	public function listing_add() {
		...
		$page_data['page_name']  = 'listing_add_wiz_1';
