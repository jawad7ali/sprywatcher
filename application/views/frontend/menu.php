<nav id="menu" class="main-menu">
	<ul>
        <li><a class="nav-link" href="<?php echo base_url();?>">Find a spray</a></li>
		<!-- <li><a class="nav-link" href="javascript:;">Shop</a></li> -->
        <li><a class="nav-link" href="<?php echo base_url();?>user/listing_add">Send Spray Entries!</a></li>
		<!-- <li><a  class="nav-link" href="<?php echo base_url();?>home/listings">Listings</a></li>
		<li><a  class="nav-link" href="<?php echo base_url();?>home/category">Category</a></li>
		<li><a  class="nav-link" href="<?php echo base_url();?>home/pricing">Pricing</a></li>

		<?php if ($this->session->userdata('is_logged_in') == 1): ?>
			<li><a  class="nav-link" href="javascript::"><?php echo get_phrase('account'); ?></a>
